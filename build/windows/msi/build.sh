...
if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  PRODUCT_NAME="PostHog Editor - Insiders"
  PRODUCT_CODE="PostHogEditorInsiders"
  ...
  PRODUCT_NAME="PostHog Editor"
  PRODUCT_CODE="PostHogEditor"
...
if [[ -z "${1}" ]]; then
	OUTPUT_BASE_FILENAME="PostHogEditor-${VSCODE_ARCH}-${RELEASE_VERSION}"
else
	OUTPUT_BASE_FILENAME="PostHogEditor-${VSCODE_ARCH}-${1}-${RELEASE_VERSION}"
fi
